...
user_no = {'10','12','96','81','83','41','80','92','73','29','34','84','44','69','13','77','15','75','65','27'}; %Mert Pehlivancik
...
sD=som_read_data(strcat('device',user_no{index},char{index2},user_count{index3},'t','.data'));
...
sDt=som_read_data(strcat('device',user_no{index},char{index2},'tt','.data'));
...
saveas(gcf,strcat('device',user_no{index},user_count{index3},char{index2}),'jpg');
close
end
end
end