...
import os
# Set folder:
folder = r"E:\COMPUTER ENGINEERIG\4.Sınıf\ArtificalNeuralNetwork\ArffFile\Test"
# Get filepaths for all files which end with ".txt"
allFiles = glob.glob(folder + "/cell*all*.arff")
...
for fp in allFiles:
    ...
    with open(fp, "w+") as f:
        f.write("@relation %s\r\n" % name)
        f.write("@attribute celltower_oid numeric \n")
